import { r as render, s as set, L as LEGACY_PROPS, g as get, f as flushSync, d as define_property, m as mutable_source, i as init_operations, a as get_first_child, C as COMMENT_NODE, H as HYDRATION_START, b as get_next_sibling, c as HYDRATION_ERROR, e as HYDRATION_END, h as hydration_failed, j as clear_text_content, k as array_from, l as component_root, n as set_active_reaction, o as set_active_effect, p as is_array, q as active_effect, t as active_reaction, u as create_text, v as branch, w as push, x as setContext, y as pop, z as push$1, A as component_context, B as pop$1, D as DEV, E as readable, F as writable } from './chunks/index-Dr4ytFAP.js';
...
<html lang="en">\r
	<head>\r
		...
		\r
		<!-- PWA Meta Tags -->\r
		<meta name="theme-color" content="#1565c0" />\r
		<meta name="description" content="Student Enrollment and Tracking System" />\r
		...
		<link rel="preload" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'" />\r
		<link rel="preload" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'" />\r
		\r
		<!-- Load Material Symbols immediately for loading screen -->\r
		<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&display=swap" />\r
		\r
		<!-- Fallback for browsers that don't support preload -->\r
		<noscript>\r
			<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" />\r
			<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&display=swap" />\r
		</noscript>\r
		\r
		<!-- Critical CSS inlined for instant render -->\r
		<style>\r
			/* Critical CSS - Base styles for immediate render */\r
			* {\r
			...
			\r
			:root {\r
				/* Essential variables for initial render */\r
				--school-primary: #1565c0;\r
				--md-sys-color-surface: #ffffff;\r
				--md-sys-color-on-surface: #1c1b1f;\r
				--md-sys-color-primary: var(--school-primary);\r
				--md-sys-color-primary-container: #e3f2fd;\r
				--transition-normal: 0.3s ease;\r
			}\r
			\r
			[data-theme="dark"] {\r
				--md-sys-color-surface: #121212;\r
				--md-sys-color-on-surface: #e0e0e0;\r
				--md-sys-color-primary-container: #1e3a8a;\r
			}\r
			\r
			html {\r
				background-color: var(--md-sys-color-surface);\r
				transition: background-color var(--transition-normal) !important;\r
			}\r
			\r
			body {\r
				margin: 0;\r
				padding: 0;\r
				font-family: 'Roboto', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;\r
				font-size: 14px;\r
				font-weight: 400;\r
				line-height: 1.5;\r
				color: var(--md-sys-color-on-surface);\r
				background-color: var(--md-sys-color-surface);\r
				-webkit-font-smoothing: antialiased;\r
				-moz-osx-font-smoothing: grayscale;\r
				transition: color var(--transition-normal), background-color var(--transition-normal);\r
			}\r
			\r
			/* Loading state styles */\r
			.app-loading {\r
				position: fixed;\r
				top: 0;\r
				left: 0;\r
			...
			\r
			.app-loading-content {\r
				text-align: center;\r
			}\r
\r
			.app-loading-icon{\r
				fill: var(--md-sys-color-on-surface);\r
				height: 120px;\r
			}\r
			\r
			.app-loading-progress {\r
				width: 280px;\r
				display: flex;\r
				align-items: center;\r
				gap: 12px;\r
			...
			.app-loading-bar {\r
					flex: 1;\r
					height: 6px;\r
					background-color: var(--md-sys-color-outline-variant);\r
					border-radius: 3px;\r
					overflow: hidden;\r
					position: relative;\r
			}\r
\r
			[data-theme="light"] .app-loading-fill {\r
    			background: linear-gradient(90deg, #222831 0%, #393e46 100%);\r
			}\r
\r
			.app-loading-fill {\r
				height: 100%;\r
				background: linear-gradient(90deg, \r
					var(--md-sys-color-primary-container) 0%, \r
					var(--md-sys-color-secondary-container) 100%);\r
				border-radius: 3px;\r
			...
			.app-loading-fill::after {\r
				...
				background: linear-gradient(90deg, \r
					transparent 0%, \r
					rgba(255, 255, 255, 0.4) 30%,\r
					rgba(255, 255, 255, 0.6) 50%,\r
					rgba(255, 255, 255, 0.4) 70%,\r
					transparent 100%);\r
				animation: shimmer 1.2s ease-in-out infinite;\r
				width: 100px;\r
			}\r
			\r
			@keyframes shimmer {\r
				0% { \r
					transform: translateX(-120px);\r
					opacity: 0;\r
				}\r
				20% {\r
					opacity: 1;\r
				...
				100% { \r
					transform: translateX(300px);\r
					opacity: 0;\r
				}\r
			}\r
			\r
			/* Hide loading when app is ready */\r
			.app-ready .app-loading {\r
				opacity: 0;\r
		...
		\r
		<script>\r
			// Set theme immediately to prevent flash\r
			(function() {\r
				try {\r
					const savedTheme = localStorage.getItem('theme');\r
					// Default to light mode if no saved preference\r
					const theme = savedTheme === 'dark' ? 'dark' : 'light';\r
					document.documentElement.setAttribute('data-theme', theme);\r
				} catch (e) {\r
					// Fallback to light mode if localStorage is not available\r
					document.documentElement.setAttribute('data-theme', 'light');\r
				}\r
			})();\r
			\r
			// App loading management\r
			window.appLoadingManager = {\r
				isReady: false,\r
				readyCallbacks: [],\r
				loadingProgress: 0,\r
				\r
				onReady: function(callback) {\r
					if (this.isReady) {\r
						callback();\r
					} else {\r
						this.readyCallbacks.push(callback);\r
					}\r
				},\r
				\r
				setReady: function() {\r
					this.isReady = true;\r
					document.documentElement.classList.add('app-ready');\r
					this.readyCallbacks.forEach(callback => callback());\r
					this.readyCallbacks = [];\r
				},\r
				\r
				updateProgress: function(progress) {\r
					this.loadingProgress = progress;\r
					const fillElement = document.getElementById('app-loading-fill');\r
					if (fillElement) {\r
						fillElement.style.width = progress + '%';\r
					}\r
				}\r
			};\r
			\r
			// Start smooth progress animation\r
			let progress = 0;\r
			const progressInterval = setInterval(() => {\r
				progress += 1;\r
				window.appLoadingManager.updateProgress(progress);\r
				if (progress >= 100) {\r
					clearInterval(progressInterval);\r
				}\r
			}, 28); // 100 steps over ~2.8 seconds for smooth animation\r
			\r
			// Auto-hide loading after maximum time\r
			setTimeout(() => {\r
				if (!window.appLoadingManager.isReady) {\r
					window.appLoadingManager.setReady();\r
				}\r
			}, 3000);\r
		<\/script>\r
		\r
